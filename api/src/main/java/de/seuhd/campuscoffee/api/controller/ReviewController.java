...
public class ReviewController extends CrudController<Review, ReviewDto, Long> {
    ...
    @RequestParam (" approved ") Boolean approved
        ...
        for (Review review : reviewService.filter(posId, approved)) {
            reviewDtos.add(reviewDtoMapper.fromDomain(review));
        }
    ...
    @RequestParam (" user_id ") Long userId
        ...
        Review approvedReview = reviewService.approve(reviewService.getById(id), userId);
